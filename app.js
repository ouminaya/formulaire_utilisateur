class Employer{
    ...
    constructor(firstname, lastname, phone, email, contract, birthday, exp, avatar){
...
if (form) {
    form.addEventListener('submit', function(e){
        ...
        employers.push(new Employer(firstname, lastname, phone, email, contract, birthday, exp, avatar))
        listEmployer(employers, tableBody)
    })
}
...
function listEmployer(employers, tableBody)
{
    ...
    for (let index = 0; index < employers.length; index++) {
        ...
        seeMore.addEventListener('click', () => {
            document.getElementById('monModal').innerHTML = "<p>" + "Téléphone: " +employers[index].phone + "</p>";
            document.getElementById('monModal').innerHTML += "<p>" + "Email: " +employers[index].email + "</p>";
